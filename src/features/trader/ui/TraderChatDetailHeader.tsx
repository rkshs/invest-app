...
import { getAccountPortfolioTotalInAccountCurrency } from '../../../shared/lib/getAccountPortfolioTotals';
...
export function TraderChatDetailHeader({
  ...
  const canOpenPortfolio = Boolean(account && onPortfolioPress);

  const portfolioMeta =
    account &&
    `${formatPortfolioMoney(
      getAccountPortfolioTotalInAccountCurrency(account.id, account.currencyCode),
